...
export default function LibrarianLayout({ children, title }: LibrarianLayoutProps) {
  ...
  // Links da navegação
  const navLinks = [
    { href: "/", label: "Dashboard", icon: <LayoutDashboard className="mr-2 h-5 w-5" /> },
    { href: "/books", label: "Livros", icon: <BookOpen className="mr-2 h-5 w-5" /> },
    { href: "/students", label: "Estudantes", icon: <Users className="mr-2 h-5 w-5" /> },
    { href: "/loans", label: "Empréstimos", icon: <RefreshCw className="mr-2 h-5 w-5" /> },
  ];
    ...
    <div className="flex h-screen bg-background">
      ...
      <aside className="bg-primary text-white w-64 flex-shrink-0 hidden md:flex flex-col overflow-y-auto">
        <div className="p-5 border-b border-primary-hover">
          ...
          <p className="text-gray-300 text-sm">Painel do Bibliotecário</p>
        </div>
